        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pesel = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarYear = table.Column<int>(type: "int", maxLength: 6, nullable: false),
                    Color = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Weight = table.Column<int>(type: "int", maxLength: 6, nullable: false),
                    PrizeForDay = table.Column<int>(type: "int", maxLength: 10, nullable: false),
                    PrizeForWeek = table.Column<int>(type: "int", maxLength: 12, nullable: false),
                    Availability = table.Column<bool>(type: "bit", nullable: false),
                    Place = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UserReservationId = table.Column<int>(type: "int", nullable: true),
                    IsReserved = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    UserBeforeId = table.Column<int>(type: "int", nullable: false),
                    RentedFrom = table.Column<DateOnly>(type: "date", nullable: false),
                    RentedTo = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cars_AspNetUsers_UserReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarsVin = table.Column<string>(type: "nvarchar(20)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Photos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Photos_Cars_CarsVin",
                        column: x => x.CarsVin,
                        principalTable: "Cars",
                        principalColumn: "Vin");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_UserReservationId",
                table: "Cars",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Photos_CarsVin",
                table: "Photos",
                column: "CarsVin",
                unique: true,
                filter: "[CarsVin] IS NOT NULL");
        }
